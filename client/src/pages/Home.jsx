        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Tableau de Bord Intelligent</h3>
              <p className="text-gray-600">
                Vue d'ensemble complète de votre activité avec indicateurs en temps réel et analytics avancés.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Gestion de Production</h3>
              <p className="text-gray-600">
                Suivez chaque commande, gérez les étapes de production et optimisez votre workflow.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Comptabilité & Finances</h3>
              <p className="text-gray-600">
                Gestion complète des finances avec suivi des dépenses, revenus et indicateurs de rentabilité.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto">
            <a
              href="/contact"
              className="block bg-blue-600 hover:bg-blue-700 text-white text-center text-lg py-4 px-8 rounded-lg font-semibold mb-8 transition-colors duration-200"
            >
              Envoyer un message
            </a>
            <div className="text-center">
              <p className="text-gray-600 mb-6">Ou contactez-nous directement :</p>
              <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-8">
                <a
                  href="https://wa.me/261344335930"
                  className="flex items-center justify-center text-green-600 hover:text-green-700 font-semibold"
                  target="_blank"
                ...
                <a
                  ...
                  className="flex items-center justify-center text-blue-600 hover:text-blue-700 font-semibold"
                >
                ...
                <a
                  href="#"
                  className="flex items-center justify-center text-blue-800 hover:text-blue-900 font-semibold"
                >
                  <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 24 24">
